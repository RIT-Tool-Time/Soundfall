...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo site_url().RES_DIR; ?>/bootstrap/css/bootstrap.min.css" />
    <link type="text/css" rel="stylesheet" href="<?php echo site_url().RES_DIR; ?>/css/cover.css"/>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand"><?php echo anchor(site_url(), lang('website_title'), 'class="navbar-brand"'); ?></h3>
              <ul class="nav masthead-nav">
                ...
                <li <?php if($page === "blog"){ echo 'class="active"';} ?>><a href="<?php echo site_url('/blog'); ?>">Blog</a></li>
                <li><a href="<?php echo site_url('account/landing'); ?>">Account</a></li>
              </ul>
            </div>
          </div>
